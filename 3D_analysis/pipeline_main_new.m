...
quiver3(centroid_3D(1), centroid_3D(2), centroid_3D(3), -vec_orientation(1)*500, -vec_orientation(2)*500, -vec_orientation(3)*500, 'r', 'LineWidth', 2);
quiver3(centroid_3D(1), centroid_3D(2), centroid_3D(3), third_axis(1)*500, third_axis(2)*500, third_axis(3)*500, 'r', 'LineWidth', 2);
xlabel('X');
ylabel('Y');
zlabel('Z');
